...
def.get.volcanoplot <- function(df.data, log2fc.cut=1, add.labels=NULL) 
{
...
output.dir <- file.path(output.dir, 'DGE_analysis', 'Pso_L_SEB_vs_NL_SEB', Sys.Date())
dir.create(output.dir, recursive = TRUE, showWarnings = FALSE)

# Comparison AD, L SEB vs Rest of skin
df = xlsx::read.xlsx('/Volumes/CH__data/Projects/Eyerich_AG_projects/ST_Sebaceous_glands__Peter_Seiringer/output/switch_signs_log2fc/2021-06-22/ST_cdr_patient_annotation_condition/20210616_LvsNL/SEB G, L, PSO vs SEB G, NL__condition 1_vs_condition 2/ST_condition 1_vs_condition 2_glmGamPoi_DGE_all_genes.xlsx',
                     sheetIndex = 1)
df$NA. <- NULL
...
# Plot Volcano plot
pdf(file = file.path(output.dir, paste0('Pso_L_SEB_vs_NL_SEB', '_Volcanoplot', '.pdf')), 
    width = 6, height = 6)
