...
output.dir <- file.path(output.dir, 'DGE_analysis', 'Pso_L__SG_vs_RestofSkin', Sys.Date())
dir.create(output.dir, recursive = TRUE, showWarnings = FALSE)

# Comparison Pso, L SEB vs Rest of skin
df = xlsx::read.xlsx('/Volumes/CH__data/Projects/Eyerich_AG_projects/ST_Sebaceous_glands__Peter_Seiringer/output/switch_signs_log2fc/2021-09-07/switch_signs/ST_cdr_patient_annotation_condition/13_DGE_Approaches_Signature_PSO_modifiedPS_20210507/L, SEB G__condition 1_vs_condition 2/ST_condition 1_vs_condition 2_glmGamPoi_DGE_all_genes.xlsx',
                     sheetIndex = 1)
df$NA. <- NULL
...
# Plot Volcano plot
pdf(file = file.path(output.dir, paste0('Pso_L__SG_vs_RestofSkin', '_Volcanoplot', '.pdf')), 
    width = 6, height = 6)
