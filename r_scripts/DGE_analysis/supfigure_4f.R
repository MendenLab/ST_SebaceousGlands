...
def.get.volcanoplot <- function(df.data, log2fc.cut, add.labels=NULL) 
{
  ...
  # Annotate top diff expressed genes
...
output.dir <- file.path(output.dir, 'DGE_analysis', 'SEB_L__Pso_vs_AE', Sys.Date())
dir.create(output.dir, recursive = TRUE, showWarnings = FALSE)

# Comparison AD, L SEB vs Rest of skin
df = xlsx::read.xlsx('/Volumes/CH__data/Projects/Eyerich_AG_projects/ST_Sebaceous_glands__Peter_Seiringer/output/switch_signs_log2fc/2021-09-07/switch_signs/ST_cdr_annotation_condition/5_DGE_Approaches_Glands_modifiedPS_20210507/SEB G, L, disease__condition 1_vs_condition 2/ST_condition 1_vs_condition 2_glmGamPoi_DGE_all_genes.xlsx',
                     sheetIndex = 1)
df$NA. <- NULL
...
# Plot Volcano plot
pdf(file = file.path(output.dir, paste0('SEB_L__Pso_vs_AE', '_Volcanoplot', '.pdf')), 
    width = 6, height = 6)
